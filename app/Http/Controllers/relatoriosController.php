...
class relatoriosController extends Controller
{
    ...
    public function servicos_mensal_pdf(Request $request)
    {
        ...
        if (empty($servico[0])) {
             return redirect()->route('admin.servicos')->with('invalido_relatorio', 'Não existem serviços cadastrados nesse mês!');
        }
        ...
        foreach ($servico as $value) {
            if ($request_ano == $value['date_ano']) {
                ...
                return redirect()->route('admin.servicos')->with('invalido_relatorio', 'Não existem serviços cadastrados nesse ano!');
            }
        }
    ...
    public function servicos_diario_pdf(Request $request)
    {
        ...
        if (empty($servico[0])) {
            return redirect()->route('admin.servicos')->with('invalido_relatorio', 'Não existem serviços cadastrados nesse dia!');
        }
