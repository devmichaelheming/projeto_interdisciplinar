<form class="form-horizontal" id="form" role="form" action="{{ url('/admin/clientes/editar/salvar') }}/{{ $id }}" method="POST" enctype="multipart/form-data" >
	...
	<div class="groups-two" style="flex-direction: column"> 
		...
		<input type="text" class="inputs" id="endereco" name="endereco" value="{{ $endereco }}">
	</div>

	<div class="groups-two" style="flex-direction: column"> 
		<span for="nascimento" class="control-label">Data de nascimento</span>
		<input type="date" class="inputs" id="nascimento" name="nascimento" value="{{ $nascimento }}">
	</div>

	<div class="groups-two" style="flex-direction: column"> 
		<span for="cidade" class="control-label">Cidade</span>
		<input type="text" class="inputs" id="cidade" name="cidade" value="{{ $cidade }}">
	</div>

	<div class="groups-two" style="flex-direction: column"> 
		<span for="cpf" class="control-label">Cpf</span>
		<input type="text" class="inputs" id="cpf" name="cpf" value="{{ $cpf }}">
	</div>
